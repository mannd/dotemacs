...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (calfw-org calfw auctex with-editor litable graphviz-dot-mode helm-projectile projectile kosmos-theme let-alist flycheck anything w3m-load company-sourcekit rvm exec-path-from-shell xcode-mode zenburn-theme frame-cmds wttrin lein htmlize dracula-theme fountain-mode js3-mode js2-mode writeroom-mode use-package tagedit swift-mode smex rainbow-delimiters paredit multiple-cursors geiser color-theme clojure-mode-extra-font-locking bbdb-vcard bbdb-csv-import)))
